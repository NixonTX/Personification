...
import 'package:persona/QUERIES/q7.dart';  // Import Q3 for option navigation
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Q5()),  // Navigate back to Q1
            );
          },
        ),
      ),
  ...
  Widget optionContainer(String optionText) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Q7()),  // Navigate to Q3
        );
      },
      child: Container(
